...
<body>
	...
	<c:if test="${result=='Yes'}">
			<img  src="<c:url value='/images/yes.jpg'/>"  border="0"  alt="旅游" width="300" height="200"/> 
		YES	
		    <a href="${pageContext.request.contextPath}/dltable_plist.action">显示plist</a><br/>
			</c:if>
			

	<c:if test="${result=='No'}">
			<img  src="<c:url value='/images/no.jpg'/>"  border="0"  alt="旅游" width="300" height="200"/> 
		NO
			</c:if>
